...
public class EvalartHomePage {
    ...
    public static final Target TXT_IMAGEN_RESPUESTA = Target.the("Campo respuesta imagen").located(By.xpath("//button[@type='submit']"));
    public static final Target TXT_FECHA_RESPUESTA = Target.the("Campo respuesta fecha").located(By.xpath("//button[@type='submit']"));
